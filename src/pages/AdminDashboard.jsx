            ...
            <div className="admin-panel">
                ...
                <CollapsibleSection title="Herramientas Adicionales" icon="fa-solid fa-toolbox" defaultOpen={true}>
                    <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', padding: '10px 0' }}>
                        ...
                        <Link to="/admin-entities" style={{ display: 'flex', alignItems: 'center', gap: '8px', textDecoration: 'none', background: 'rgba(59, 130, 246, 0.2)', border: '1px solid var(--accent)', padding: '12px 16px', borderRadius: '8px', color: 'white', fontWeight: 'bold' }}>
                            <i className="fa-solid fa-id-card"></i> Pilotos, Equipos y Carreras V3
                        </Link>
